<template>
	<view class="uni-calendar">
		...
		<view v-if="insert || show" class="uni-calendar__content" :class="{'uni-calendar--fixed':!insert,'uni-calendar--ani-show':aniMaskShow}" :style="{'bottom': bottom + 'px'}">
...
<script>
	...
	export default {
      ...
      bottom: { // 底部安全距离,inphoneX底部会有小黑条遮挡
        type: Number,
        default: 0
      }
		},
