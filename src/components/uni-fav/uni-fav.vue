<template>
	<view :class="[circle === true || circle === 'true' ? 'uni-fav--circle' : '']" :style="[{ backgroundColor: checked ? bgColorChecked : bgColor }]" @click="onClick" class="uni-fav">
		...
		<view class="uni-fav-star" v-if="!checked && (star === true || star === 'true')">
			<yu-icons type="star-filled" :color="fgColor" :style="{color: checked ? fgColorChecked : fgColor}" size="14" />
		</view>
		<!-- #endif -->
		<!-- #ifndef MP-ALIPAY -->
		<yu-icons type="star-filled" :color="fgColor" :style="{color: checked ? fgColorChecked : fgColor}" size="14" v-if="!checked && (star === true || star === 'true')" />
		<!-- #endif -->
