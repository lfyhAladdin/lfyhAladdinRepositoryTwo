  ...
  data() {
    return {
      ...
      applicationlist: [
        ...
        {
          imgurl: "./static/images/index/firstCRoom.svg",
          name: "一手商用房",
          url: "index/ordinaryQRcode/ordinaryQRcode?from=firstcommercialroom"
        },
        {
          imgurl: "./static/images/index/secondCRoom.svg",
          name: "二手商用房",
          url: "index/ordinaryQRcode/ordinaryQRcode?from=secondcommercialroom"
        }
      ]
    };
  },
