<template>
  <view class="uni-container">
    <!-- <view class="uni-hello-text">
      <text class="hello-text">yu-app内置组件，展示样式仅供参考，文档详见：</text>
      <u-link class="hello-link" href="http://192.168.251.163:9527/yu-app-guide/component/" text="http://192.168.251.163:9527/yu-app-guide/component/" :inWhiteList="true"></u-link>
    </view> -->
