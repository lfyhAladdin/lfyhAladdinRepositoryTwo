<template>
	<view class="warp">
		...
		<view class="example-body">
			<!-- 因为swiper特性的关系，请指定swiper的高度 ，swiper的高度并不会被内容撑开. 支付宝小程序通过设置 swiper item 元素高度来控制，swiper-item 的高度取决于第一个 swiper-item 的高度。(直接设置swiper-item标签的高度也无效,需要设置第一个swiper-item的子元素的高度)-->
		...
		<view class="example-body">
			<uni-grid :column="4" border-color="#03a9f4" @change="change">
				<uni-grid-item :index="0">
					<view class="grid-item-box">
						<image class="image" src="/static/images/c1.png" mode="aspectFill" />
					</view>
				</uni-grid-item>
				<uni-grid-item :index="1">
					<view class="grid-item-box">
						<image class="image" src="/static/images/c2.png" mode="aspectFill" />
					</view>
				</uni-grid-item>
				<uni-grid-item :index="2">
					<view class="grid-item-box">
						<image class="image" src="/static/images/c3.png" mode="aspectFill" />
					</view>
				</uni-grid-item>
				<uni-grid-item :index="3">
					<view class="grid-item-box">
						<image class="image" src="/static/images/c4.png" mode="aspectFill" />
					</view>
				</uni-grid-item>
			</uni-grid>
		</view>
...
<script>
  ...
  export default {
		components: { uniSection, uniGrid, uniBadge, uniGridItem },
		data() {
			return {
				dynamicList: [],
				list: [{
					...
					{
						url: '/static/images/c3.png',
						text: 'Grid 3',
						badge: '99',
						type: "warning"
					},
					{
						url: '/static/images/c4.png',
						text: 'Grid 4',
						badge: '2',
						type: "error"
					},
					{
						url: '/static/images/c5.png',
						text: 'Grid 5'
					},
					{
						url: '/static/images/c6.png',
						text: 'Grid 6'
					},
					{
						url: '/static/images/c7.png',
						text: 'Grid 7'
					},
					{
						url: '/static/images/c8.png',
						text: 'Grid 8'
					},
					{
						url: '/static/images/c9.png',
						text: 'Grid 9'
					}
				]
			}
			...
			add() {
				if (this.dynamicList.length < 9) {
					this.dynamicList.push({
						url: `/static/images/c${this.dynamicList.length+1}.png`,
