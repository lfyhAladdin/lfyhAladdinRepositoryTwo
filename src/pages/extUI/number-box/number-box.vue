<template>
	<view class="page">
		...
		<view class="example-body">uni-number-box 
			<uni-number-box />
		</view>
		...
		<uni-section :title="numberValueTitle" type="line"></uni-section>
		<view class="example-body">
...
<script>
  ...
  import uniNumberBox from '@/components/uni-number-box/uni-number-box.vue';
	export default {
		components: { yuInput, uniSection, uniNumberBox },
		data() {
			return {
				numberValueTitle: '获取输入的值 : 0',
				numberValue: 0,
			}
    },
		methods: {
        ...
        this.numberValueTitle = '获取输入的值 : ' + this.numberValue;
			}
		}
	}
</script>
