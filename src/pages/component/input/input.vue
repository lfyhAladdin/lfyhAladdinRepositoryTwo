<template>
  <view class="nvue-page-root">
    ...
    <view class="uni-common-mt">
      ...
      <view class="uni-form-item uni-column">
        <view class="title">
          <text class="uni-form-item__title">键盘右下角按钮显示为搜索</text>
          <text class="tip-text">注：部分系统版本太低的手机可能不支持</text>
        </view>
        <view class="uni-input-wrapper">
      ...
      <view class="uni-form-item uni-column">
        <view class="title">
          <text class="uni-form-item__title">键盘右下角按钮显示为发送</text>
          <text class="tip-text">注：仅支持微信、支付宝小程序</text>
        </view>
        <view class="uni-input-wrapper">
      ...
      <view class="uni-form-item uni-column">
        <view class="title">
          <text class="uni-form-item__title">身份证输入的 input</text>
          <text class="tip-text">注：仅支持微信、支付宝小程序</text>
        </view>
        <view class="uni-input-wrapper">
      ...
      <view class="uni-form-item uni-column">
        ...
        <view class="uni-input-wrapper">
          ...
          <text class="uni-icon" v-else></text>
        </view>
      </view>
      <view class="uni-form-item uni-column">
...
<script>
  ...
  export default {
    ...
    onLoad() {
      this.platform = yu.getSystemInfoSync().platform;
      // #ifdef APP-PLUS-NVUE
      this.isNvue = true;
      // #endif
    }
