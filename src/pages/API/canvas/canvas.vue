...
<script>
	...
	export default {
		...
		onReady: function() {
			context = yu.createCanvasContext('canvas',this)
		},
		methods: {
			toTempFilePath: function() {
				yu.canvasToTempFilePath({
					canvasId: 'canvas',
			...
			drawImage: function() {
				// #ifdef APP-PLUS
				context.drawImage('../../../static/images/app-plus/yu2x.png', 0, 0)
				// #endif
				// #ifndef APP-PLUS
				context.drawImage('../../../static/images/yu.png', 0, 0)
				// #endif
				context.draw()
			},
			fillText: function() {
