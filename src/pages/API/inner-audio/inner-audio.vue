<template>
	<view class="uni-padding-wrap inner-audio-page-box">
...
<script>
	...
	export default {
		...
		computed: {
			...
			playImage() {
				return this.isPlaying ? "/static/images/pause.png" : "/static/images/play.png"
			}
		},
		onLoad() {
		...
		methods: {
			createAudio() {
				var innerAudioContext = this._audioContext = yu.createInnerAudioContext();
