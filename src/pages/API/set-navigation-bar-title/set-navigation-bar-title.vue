<template>
  <view class="page">
    ...
    <view class="uni-padding-wrap">
      <view class="uni-helllo-text">本页标题栏是yu-app的默认配置，开发者可在pages.json里配置文字内容及标题颜色，也可通过api接口将其改变。</view>
    ...
    methods: {
      setText() {
        ...
        yu.setNavigationBarTitle({
          title: this.hasSetText ? 'Hello yu-app' : '默认导航栏'
        });
      },
      setBg() {
        this.hasSetBg = !this.hasSetBg;
        yu.setNavigationBarColor({
