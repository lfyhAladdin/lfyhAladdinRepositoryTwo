<template>
	<view>
      ...
      <!-- <view class="system-info-link-box">
        <text>更多系统信息请查看文档：</text>
        <u-link class="system-info-link" href="http://192.168.251.163:9527/yu-app-guide/api/system/info.html" text="http://192.168.251.163:9527/yu-app-guide/api/system/info.html" :inWhiteList="true"></u-link>
      </view> -->
	...
	export default {
		...
		methods: {
			getSystemInfo: function () {
				yu.getSystemInfo({ // 支付宝小程序获取的IOS系统的手机型号可能不准确
					success: (res) => {
            console.log(res)
						this.systemInfo = res;
					}
